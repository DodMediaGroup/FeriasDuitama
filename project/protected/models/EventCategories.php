...
class EventCategories extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('status_category', 'numerical', 'integerOnly'=>true),
			array('name_category', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_category, name_category, status_category', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'events' => array(self::HAS_MANY, 'Events', 'event_categories_id_category'),
		);
	}
